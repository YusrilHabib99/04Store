                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    ...
                                    <a href=" {{url('admin/users/'.$user->id.'/delete')}} " onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" class="btn btn-sm btn-danger">
                                        Hapus
                                    </a>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="5">Tidak ada User Tersedia</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
